   {{-- <div class="card"> --}}
    <div class="card-body">
      ...
      <div class="modal fade" id="modaltambahsensor" tabindex="-1">
            ...
            <div class="modal-body">
              <form action="{{ route('sensor.save') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-12">
                  ...
                  <input type="text" name="volume_infus" class="form-control" id="inputNanme4">
                </div>
                <div class="col-12">
...
{{-- <div class="card"> --}}
    <div class="card-body">
      <!-- Vertically centered Modal -->
      <div class="modal fade" id="modalsensoredit{{ $val->id }}" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              <form class="row g-3" action="{{ route('sensor.save') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Volume</label>
                  <input type="text" name="volume_infus" value="{{ $val->volume_infus }}" class="form-control" id="inputNanme4">
                </div>
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Tetesan</label>
