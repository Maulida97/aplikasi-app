                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="{{ route('bangsal.add') }}" method="post" enctype="multipart/form-data">
                            @csrf
                          <div class="col-12">
                ...
                <div class="modal fade" id="modaledit{{ $val->id }}" tabindex="-1">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form class="row g-3" action="{{ route('bangsal.add') }}" method="post" enctype="multipart/form-data">
