                      ...
                      <div class="modal-body">
                        <form action="{{ route('pasien.save') }}" method="post" enctype="multipart/form-data">
                          ...
                          <div class="col-12 mt-3">
                            ...
                            <input type="text" placeholder="Masukan Nama Pasien" name="nama_pasien" class="form-control" id="inputNanme4" required>
                          </div>
                          ...
                          <div class="col-12 mt-3">
                            ...
                            <select name="sensor_id"  class="form-select">
                              ...
                              <option value="{{ $value->id }}">{{ $value->nama_sensor }}</option>
                              @endforeach
                            </select>
                          </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="col-12 mt-3">
                          <label for="inputState" class="form-label">Status Kamar</label>
                          <select name="status"  class="form-select" required >
                            <option selected>{{ $val->status }}</option>
                            <option value="ya">Ya</option>
                            <option value="tidak">Tidak</option>
                          </select>
                        </div>
