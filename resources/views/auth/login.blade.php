                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Login vvvv to Your Account</h5>
                                    ...
                                    <form class="row g-3 needs-validation" action="{{ route('login') }}" method="POST"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="text" name="username" placeholder="Masukan Username"
                                                    class="form-control" id="yourUsername" autocomplete="off"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="password" name="password" placeholder="Password"
                                                class="form-control" id="yourPassword" autocomplete="off"
