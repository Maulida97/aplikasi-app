                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" action="{{ route('register.create') }}"
                                        method="POST" novalidate>
                                        @csrf
                                        <div class="col-12">
                                            {{-- <input type="text" class="form-control" placeholder="Name" name="name"
                                                id="name" @error('name') is-invalid @enderror required> --}}
                                            ...
                                            <input type="text" name="name" placeholder="Your Name"
                                                class="form-control" id="yourName" @error('name') is-invalid @enderror
                                                required>
                                            @error('name')
                                                <div class="invalid-feddback">
                                                    {{ $message }}
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="username" placeholder="Users Name"
